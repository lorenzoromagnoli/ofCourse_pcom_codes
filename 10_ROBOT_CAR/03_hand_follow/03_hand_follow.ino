/*
 * example code to control a robot car using our hand. 
 * the robot will try to maintain always the same 20cm distance from any 
...
void loop() {
  ...
  int distanceFromHand=sonar.ping_cm();
  setRobotSpeed(100);

  if (distanceFromHand>20){
    moveForward();
  }else{
    moveBackward();
  }
